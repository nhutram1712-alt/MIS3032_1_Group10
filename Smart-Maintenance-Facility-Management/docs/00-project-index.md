...
| Cần sửa | Đã phát hiện lỗi/mâu thuẫn, đang chờ xử lý |
...
| `business-rules.md` | 18 Business Rules (BR-01→BR-18) | **Cần sửa** — BR-14, BR-15 hiện sai nội dung (xem `decision-log.md` DEC-09) |
